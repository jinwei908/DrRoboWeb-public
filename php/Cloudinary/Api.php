...
class Api {
  ...
  function resource($public_id, $options=array()) {
    ...
    return Api::call_api("get", $uri, Api::only($options, array("exif", "colors", "faces", "image_metadata", "phash", "pages", "coordinates", "max_results")), $options);
  }
